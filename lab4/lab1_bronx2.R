...
bronx1<-read.xls(file.choose(),pattern="BOROUGH",stringsAsFactors=FALSE,sheet=1,perl="C:/Perl64/bin/perl.exe") 
...
register_google(key = "AIzaSyAu7o-gRQBKMW8TgAhhBBwkDqSSRsj-Z6E")
